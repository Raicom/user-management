 ...
 * @property UserDirection $direction
 */
class User extends UserIdentity
{
    ...
    public function rules()
    {
        return [
            ...
            [['state_id','direction_id'], 'integer'],
            [['state_id','direction_id'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'email' => 'E-mail',
            'statesCode' => Yii::t('app', 'Office state'),
            'directionDescr' => Yii::t('app', 'Direction'),
        ];
    }
    ...
    /* Getter for modified state code */
    public function getStatesCode()
    {
        return $this->states->code;
    }

    /* Getter for modified state name */
    ...
    {
        return $this->hasOne(UserDirection::className(), ['direction_id' => 'direction_id']);
    }

    /* Getter for modified state code */
    public function getDirectionDescr()
    {
        return $this->direction->descr;
    }
}
