 ...
 *
 * @property LutLocations $location
 * @property LutDepartments $department
 * @property DaConfigs $config
 */
class User extends UserIdentity
{
    ...
    public function rules()
    {
        return [
            ...
            [['location_id', 'department_id', 'config_id'], 'integer'],
            [['location_id', 'department_id', 'config_id'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'email' => 'E-mail',
            'locationName' => Yii::t('app', 'Location'),
            'departmentName' => Yii::t('app', 'Department'),
            'configName' => Yii::t('app', 'Config'),
    ...
    {
        return $this->hasOne(LutLocations::className(), ['id' => 'location_id']);
    }

    /* Getter for modified location name */
    ...
    {
        return $this->hasOne(LutDepartments::className(), ['id' => 'department_id']);
    }
    ...
    {
        return $this->hasOne(DaConfigs::className(), ['id' => 'config_id']);
    }
